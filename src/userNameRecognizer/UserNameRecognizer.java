...
public class UserNameRecognizer {
	...
	private static boolean foundInvalidCharacter;       // Lets program know if invalid character was found
														// running
	private static int userNameSize = 0;			// A numeric value may not exceed 30 characters
	...
	public static String checkForValidUserName(String input) {
		...
		foundInvalidCharacter = false;      // Start as false because nothing was found yet
		...
		case 1:
			...
			if (userNameSize < 3) {
				...
				userNameRecognizerErrorMessage += "A UserName must have\n"
						+ " at least 3 characters.\n";
				return userNameRecognizerErrorMessage;
			}
			else if (userNameSize > 30) {
				// UserName is too long
				userNameRecognizerErrorMessage += 
					"A UserName must have no \n"
					+ "more than 30 characters.\n";
				return userNameRecognizerErrorMessage;
			}
			else if (foundInvalidCharacter) {
