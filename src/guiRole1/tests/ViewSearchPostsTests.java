...
public class ViewSearchPostsTests {
	 ...
	 *
	 *  <p>Procedure:</p>
	 *  <p>1. Starting in the Student Home Page, click the "Search" button
	 *  to bring you to the ViewSearchPosts page.</p>
	 *
	 *  <p>2. Press search.</p>
	 *
	 *  <p>Expected output: Red text under the 2nd horizontal separator that states:
	 ...
	 *  to bring you to the ViewSearchPosts page.</p>
	 *
	 *  <p>2. In the TextBox next to "Enter search keyword:", enter the keyword
	 *  of your choosing.</p>
	 *
	 *  <p>3. Press search.</p>
	 *
	 *  <p>Expected output: There are two different expected outputs, depending on what posts exist.</p>
	 *
	 *  <p>If there are no posts that match the keywords, you should see a Label stating:
	 *  "No results found for: '{your entered keyword}'" and the box beneath it stating:
	 *  "No post contains this keyword. Try different keywords."</p>
	 *
	 *  <p>If there is one post or more that matches the keyword, it will be listed in the box
