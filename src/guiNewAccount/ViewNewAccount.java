...
public class ViewNewAccount {
	...
	*/
    ...
    // This alert is used should the invitation code be past its deadline
    protected static Alert alertInvitationCodeIsExpired = new Alert(AlertType.INFORMATION);

	// This alert is used should the user enter two passwords that do not match
	protected static Alert alertPasswordNotMatchError = new Alert(AlertType.INFORMATION);
	
	// This alert is used should the user enter a username that doesn't fit the rules
	protected static Alert alertBadUsernameError = new Alert(AlertType.INFORMATION);
	
	// This alert is used should the user enter a password that doesn't fit the rules
	protected static Alert alertBadPasswordError = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	public static void displayNewAccount(Stage ps, String ic) {
		...
		deadline = theDatabase.getDeadlineGivenAnInvitationCode(theInvitationCode);
		
		if (System.currentTimeMillis() > deadline) {
			alertInvitationCodeIsExpired.showAndWait();
			return;
		}
	...
	private ViewNewAccount() {
		...
		// If the invitation code is expired, this alert dialog will tell the user
		alertInvitationCodeIsExpired.setTitle("Invitation Code Expired");
		alertInvitationCodeIsExpired.setHeaderText("The invitation code is past its deadline.");
		alertInvitationCodeIsExpired.setContentText("Get a new code and try again.");

		// If the passwords do not match, this alert dialog will tell the user
		alertPasswordNotMatchError.setTitle("Passwords Do Not Match");
		alertPasswordNotMatchError.setHeaderText("The two passwords must be identical.");
		alertPasswordNotMatchError.setContentText("Correct the passwords and try again.");
		
		// If the username doesn't fit the requirements, this alert dialog will tell the user
		alertBadUsernameError.setTitle("Username Error");
		alertBadUsernameError.setHeaderText("Invalid username.");
		
		// If the password doesn't fit the requirements, this alert dialog will tell the user
		alertBadPasswordError.setTitle("Password Error");
		alertBadPasswordError.setHeaderText("Invalid password.");
